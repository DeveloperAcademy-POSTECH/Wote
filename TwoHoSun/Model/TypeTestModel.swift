...
let typeTests = [
    TypeTestModel(question: "친구들과 쇼핑몰에 갔을 때나는 주로···",
                  ...
                  choices: [
                    ...
                    ChoiceModel(choice: "이벤트홀에 가면 새로운 세일 제품들이 업데이트 되었대. 거기부터 가보자!", types: [.saving]),
    ...
    TypeTestModel(question: "내가 추구하는 소비 스타일은?",
                  ...
                  choices: [
                    ...
                    ChoiceModel(choice: "요즘 제일 트렌디하고 다들 좋다는 걸 사", types: [.trendy]),
                    ChoiceModel(choice: "내가 써봤던 익숙한 제품이 좋아!", types: [.safetyShopper]),
                    ChoiceModel(choice: "최대한 싸고 가성비 좋은 거!", types: [.saving])
                  ]),
    TypeTestModel(question: "친구 생일 선물을 사야 할 때 나는?",
                  ...
                  choices: [
                    ...
                    ChoiceModel(choice: "인스타에서 요즘 유행하는 걸로 사줘야겠다!", types: [.trendy]),
                    ChoiceModel(choice: "내가 써봤을 때 좋았던 경험이 있던걸로 사야겠다!", types: [.safetyShopper])
                  ]),
    TypeTestModel(question: "나의 쇼핑 습관을 한마디로 표현하면?",
                  highlight: "쇼핑 습관을 한마디",
                  choices: [
                    ChoiceModel(choice: "일단 사고 보는 편이야", types: [.impulseBuyer]),
                    ChoiceModel(choice: "최신 유행을 따라가야지!", types: [.trendy]),
                    ChoiceModel(choice: "가격 대비 품질이 최고!", types: [.saving]),
    ...
    TypeTestModel(question: "나의 쇼핑 모토는?",
                  highlight: "쇼핑 모토",
                  choices: [
                    ChoiceModel(choice: "신뢰할 수 있는 브랜드만 골라!", types: [.safetyShopper]),
                    ChoiceModel(choice: "가격이 저렴하면 그게 최고야!", types: [.saving]),
