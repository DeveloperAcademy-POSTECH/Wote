...
//        do {
//            let votes = try decoder.decode([VoteInfoDTO].self, from: jsonData)
//            let summary = summarizeVotes(voteInfoDTOs: votes)
//            let chartModel = summarizeToChartModel(summary: summary)
//            printChartModel(chartModel: chartModel)
